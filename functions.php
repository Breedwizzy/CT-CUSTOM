...
function theme_settings_page($wp_customize)
{
	// Create a custom section for the theme settings
...
add_action('customize_register', 'theme_settings_page');

function theme_settings_fields($wp_customize)
{
	...
	// Phone Number
	$wp_customize->add_setting('theme_phone', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field',
	)
	);

	$wp_customize->add_control('theme_phone', array(
		'label' => 'Phone Number',
		'section' => 'theme_settings',
		'type' => 'text',
	)
	...
	// Fax Number
	$wp_customize->add_setting('theme_fax', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field',
	)
	);

	$wp_customize->add_control('theme_fax', array(
		'label' => 'Fax Number',
		'section' => 'theme_settings',
		'type' => 'text',
	)
	...
	// Social Media Links
	$wp_customize->add_setting('theme_facebook', array(
		'default' => '',
		'sanitize_callback' => 'esc_url_raw',
	)
	);
	...
	// Add controls for other social media links (e.g., Instagram, Twitter, Pinterest)
}
add_action('customize_register', 'theme_settings_fields');

// Display the Theme Settings
$logo_url = get_theme_mod('theme_logo');
$phone_number = get_theme_mod('theme_phone', '');
$address_info = get_theme_mod('theme_address', '');
$fax_number = get_theme_mod('theme_fax', '');
$facebook_link = get_theme_mod('theme_facebook', '');

// Use these variables in your theme templates to display the information and logos as needed
